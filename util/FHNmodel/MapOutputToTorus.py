'''
Map the solution of the FitzHugh Nagumo model found from the C script onto the torus generated by GenTorus
'''
...
if __name__ == '__main__':
    ...
    # Hopf bifurcation position (at beta = 1, only for FHN model)
    ...
    # load first processor's data for variables U and V
    ...
    for tstep in range(nt):
        ...
        torus.GetCellData().AddArray(activatorArray)  # main variable
